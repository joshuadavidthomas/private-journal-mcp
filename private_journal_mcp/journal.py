...
def get_user_journal_path() -> Path:
    """Get user data directory for personal journal storage.
...
def get_project_journal_path() -> Path:
    """Get project directory for project-specific journal storage.
